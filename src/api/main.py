...
from api.routes import alerts, cameras, congestion, dashboard, health, heatmap, incidents, metrics
...
app.include_router(heatmap.router, tags=["map"])
app.include_router(incidents.router, tags=["map"])
